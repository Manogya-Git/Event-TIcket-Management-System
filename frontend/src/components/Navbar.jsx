...
const Navbar = () => {
  ...
  const eventButtonClass = () =>
    "rounded-md bg-lime-400 px-5 py-2 text-sm font-semibold text-black transition-colors hover:bg-lime-300";

  return (
    <nav className=" flex flex-wrap items-center justify-between gap-4 bg-black px-6 py-4 md:px-10 sticky top-0 z-50">
      <Link
        to="/"
        className="text-[1.65rem] font-extrabold tracking-tight text-lime-400"
      >
        k garira?
      </Link>
