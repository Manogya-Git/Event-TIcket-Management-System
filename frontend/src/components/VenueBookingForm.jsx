  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `${BASE_URL}/booking/venue-inquiries/`,
        { ...formData, artist: artistId },
      ...
      if (error.response?.data) {
        ...
        // Request went out but no response came back (network/CORS issue)
        errorMessage =
      ...
      <div className="mx-auto max-w-4xl rounded-2xl border border-neutral-800 bg-neutral-900 p-5 shadow-[0_10px_30px_rgba(0,0,0,0.22)] sm:p-8 lg:p-10">
        <div className="mb-8 border-b border-neutral-800 pb-6">
          ...
          <p className="mt-2 text-sm text-neutral-400">
            Tell us about your event and we&apos;ll confirm the details.
          </p>
        </div>
