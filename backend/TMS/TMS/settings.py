...
SECRET_KEY = 'django-insecure-t(vnd*iun%!t4l@*7h+=%czgzph=7*bt0(o3yyyp1qxt3ya=r!'
...
KHALTI_SUCCESS_URL = os.environ.get("KHALTI_SUCCESS_URL")
...
DEFAULT_FROM_EMAIL = f"TMS <{EMAIL_HOST_USER}>"
